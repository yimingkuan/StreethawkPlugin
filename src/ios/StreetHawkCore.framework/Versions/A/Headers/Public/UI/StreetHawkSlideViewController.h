 ...
 */
enum StreetHawkSlideDirection
{
    /**
     Move from device's bottom to up.
     */
    StreetHawkSlideDirection_Up = 0,
    /**
     Move from device's top to down.
     */
    StreetHawkSlideDirection_Down = 1,
    /**
     Move from device's right to left.
     */
    StreetHawkSlideDirection_Left = 2,
    /**
     Move from device's left to right.
     */
    StreetHawkSlideDirection_Right = 3,
};
typedef enum StreetHawkSlideDirection StreetHawkSlideDirection;

/**
 Callback for `StreetHawkSlideContentViewController` load finish.
 */
typedef void(^StreetHawkSlideContentLoadFinish)(BOOL isSuccesss);

/**
 Protocal for slide content to implement.
 */
@protocol StreetHawkSlideContentViewController <NSObject>
 ...
 */
@property (copy, nonatomic) StreetHawkSlideContentLoadFinish contentLoadFinishHandler;
 ...
 */
@interface StreetHawkApp (SlideExt)
...
/**
 ...
 @param direction The slide show direction, refer to enum `StreetHawkSlideDirection`.
 ...
 */
- (void)slideForUrl:(NSString *)url withDirection:(StreetHawkSlideDirection)direction withSpeed:(double)speed withCoverPercentage:(double)percentage withHideLoading:(BOOL)isHideLoading withAlertTitle:(NSString *)alertTitle withAlertMessage:(NSString *)alertMessage;
...
/**
 ...
 @param alertMessage Same as `alertTitle`.
 */
- (void)slideForVC:(UIViewController<StreetHawkSlideContentViewController> *)contentVC withDirection:(StreetHawkSlideDirection)direction withSpeed:(double)speed withCoverPercentage:(double)percentage withHideLoading:(BOOL)isHideLoading withAlertTitle:(NSString *)alertTitle withAlertMessage:(NSString *)alertMessage;
