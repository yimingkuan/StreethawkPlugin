...
/**
 Static function to get log database file path. This is independent on SHLogger instance so must make it static. It's /Library/StreetHawk/logline.db, this path can be backup by iTunes.
